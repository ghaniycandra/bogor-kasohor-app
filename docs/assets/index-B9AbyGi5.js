var U=a=>{throw TypeError(a)};var O=(a,e,t)=>e.has(a)||U("Cannot "+t);var h=(a,e,t)=>(O(a,e,"read from private field"),t?t.call(a):e.get(a)),A=(a,e,t)=>e.has(a)?U("Cannot add the same private member more than once"):e instanceof WeakSet?e.add(a):e.set(a,t),q=(a,e,t,o)=>(O(a,e,"write to private field"),o?o.call(a,t):e.set(a,t),t),_=(a,e,t)=>(O(a,e,"access private method"),t);(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const n of document.querySelectorAll('link[rel="modulepreload"]'))o(n);new MutationObserver(n=>{for(const r of n)if(r.type==="childList")for(const i of r.addedNodes)i.tagName==="LINK"&&i.rel==="modulepreload"&&o(i)}).observe(document,{childList:!0,subtree:!0});function t(n){const r={};return n.integrity&&(r.integrity=n.integrity),n.referrerPolicy&&(r.referrerPolicy=n.referrerPolicy),n.crossOrigin==="use-credentials"?r.credentials="include":n.crossOrigin==="anonymous"?r.credentials="omit":r.credentials="same-origin",r}function o(n){if(n.ep)return;n.ep=!0;const r=t(n);fetch(n.href,r)}})();class oe{static async getAllStories(e){return await(await fetch("https://story-api.dicoding.dev/v1/stories?location=1",{method:"GET",headers:{Authorization:`Bearer ${e}`}})).json()}}const K=(a,e)=>e.some(t=>a instanceof t);let J,Z;function re(){return J||(J=[IDBDatabase,IDBObjectStore,IDBIndex,IDBCursor,IDBTransaction])}function ie(){return Z||(Z=[IDBCursor.prototype.advance,IDBCursor.prototype.continue,IDBCursor.prototype.continuePrimaryKey])}const z=new WeakMap,N=new WeakMap,$=new WeakMap;function se(a){const e=new Promise((t,o)=>{const n=()=>{a.removeEventListener("success",r),a.removeEventListener("error",i)},r=()=>{t(P(a.result)),n()},i=()=>{o(a.error),n()};a.addEventListener("success",r),a.addEventListener("error",i)});return $.set(e,a),e}function le(a){if(z.has(a))return;const e=new Promise((t,o)=>{const n=()=>{a.removeEventListener("complete",r),a.removeEventListener("error",i),a.removeEventListener("abort",i)},r=()=>{t(),n()},i=()=>{o(a.error||new DOMException("AbortError","AbortError")),n()};a.addEventListener("complete",r),a.addEventListener("error",i),a.addEventListener("abort",i)});z.set(a,e)}let R={get(a,e,t){if(a instanceof IDBTransaction){if(e==="done")return z.get(a);if(e==="store")return t.objectStoreNames[1]?void 0:t.objectStore(t.objectStoreNames[0])}return P(a[e])},set(a,e,t){return a[e]=t,!0},has(a,e){return a instanceof IDBTransaction&&(e==="done"||e==="store")?!0:e in a}};function ee(a){R=a(R)}function ce(a){return ie().includes(a)?function(...e){return a.apply(G(this),e),P(this.request)}:function(...e){return P(a.apply(G(this),e))}}function de(a){return typeof a=="function"?ce(a):(a instanceof IDBTransaction&&le(a),K(a,re())?new Proxy(a,R):a)}function P(a){if(a instanceof IDBRequest)return se(a);if(N.has(a))return N.get(a);const e=de(a);return e!==a&&(N.set(a,e),$.set(e,a)),e}const G=a=>$.get(a);function ue(a,e,{blocked:t,upgrade:o,blocking:n,terminated:r}={}){const i=indexedDB.open(a,e),c=P(i);return o&&i.addEventListener("upgradeneeded",s=>{o(P(i.result),s.oldVersion,s.newVersion,P(i.transaction),s)}),t&&i.addEventListener("blocked",s=>t(s.oldVersion,s.newVersion,s)),c.then(s=>{r&&s.addEventListener("close",()=>r()),n&&s.addEventListener("versionchange",u=>n(u.oldVersion,u.newVersion,u))}).catch(()=>{}),c}const me=["get","getKey","getAll","getAllKeys","count"],pe=["put","add","delete","clear"],H=new Map;function Y(a,e){if(!(a instanceof IDBDatabase&&!(e in a)&&typeof e=="string"))return;if(H.get(e))return H.get(e);const t=e.replace(/FromIndex$/,""),o=e!==t,n=pe.includes(t);if(!(t in(o?IDBIndex:IDBObjectStore).prototype)||!(n||me.includes(t)))return;const r=async function(i,...c){const s=this.transaction(i,n?"readwrite":"readonly");let u=s.store;return o&&(u=u.index(c.shift())),(await Promise.all([u[t](...c),n&&s.done]))[0]};return H.set(e,r),r}ee(a=>({...a,get:(e,t,o)=>Y(e,t)||a.get(e,t,o),has:(e,t)=>!!Y(e,t)||a.has(e,t)}));const ge=["continue","continuePrimaryKey","advance"],Q={},W=new WeakMap,te=new WeakMap,fe={get(a,e){if(!ge.includes(e))return a[e];let t=Q[e];return t||(t=Q[e]=function(...o){W.set(this,te.get(this)[e](...o))}),t}};async function*be(...a){let e=this;if(e instanceof IDBCursor||(e=await e.openCursor(...a)),!e)return;e=e;const t=new Proxy(e,fe);for(te.set(t,e),$.set(t,G(e));e;)yield t,e=await(W.get(t)||e.continue()),W.delete(t)}function X(a,e){return e===Symbol.asyncIterator&&K(a,[IDBIndex,IDBObjectStore,IDBCursor])||e==="iterate"&&K(a,[IDBIndex,IDBObjectStore])}ee(a=>({...a,get(e,t,o){return X(e,t)?be:a.get(e,t,o)},has(e,t){return X(e,t)||a.has(e,t)}}));const he="bogor-kasohor-db",ye=1,E="saved_stories",M=ue(he,ye,{upgrade(a){a.objectStoreNames.contains(E)||a.createObjectStore(E,{keyPath:"id"})}}),C={async putStory(a){if(a.hasOwnProperty("id"))return(await M).put(E,a)},async getAllStories(){return(await M).getAll(E)},async getStory(a){if(a)return(await M).get(E,a)},async deleteStory(a){return(await M).delete(E,a)},async clearAllStories(){return(await M).clear(E)}};class ke{showStories(e,t){const o=document.querySelector("#kumpulan-cerita");let n="";e.forEach(r=>{if(r.lat&&r.lon){const u=L.marker([r.lat,r.lon]).addTo(t),b=r.description.length>50?r.description.substring(0,50)+"...":r.description;u.bindPopup(`
        ...
        `)}const i=new Date(r.createdAt).toLocaleDateString("id-ID",{year:"numeric",month:"long",day:"numeric"}),c=`teks-lokasi-${r.id}`;let s="";r.lat&&r.lon?s=`<p id="${c}" class="cerita-date cerita-loc">📍 Melacak lokasi satelit...</p>`:s='<p class="cerita-date cerita-loc">📍 Lokasi: Tidak disematkan</p>',n+=`
    ...
    `}async afterRender(){try{const e=localStorage.getItem("userToken"),t=L.tileLayer("https://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png",{maxZoom:19,attribution:"© OpenStreetMap"}),o=L.tileLayer("https://{s}.tile.opentopomap.org/{z}/{x}/{y}.png",{maxZoom:17,attribution:"© OpenTopoMap"}),n=L.map("map",{center:[-6.597463242797301,106.7995607513227],zoom:10,layers:[t]});L.control.layers({"Peta Standar":t,"Peta Topografi":o}).addTo(n);let r=L.popup();if(n.on("click",l=>{const k=l.latlng.lat,y=l.latlng.lng;r.setLatLng(l.latlng).setContent(`
          ...
          `).openOn(n)}),window.bawaKoordinatDanPindah=(l,k)=>{if(!localStorage.getItem("userToken")){alert("Silakan login terlebih dahulu untuk menambah cerita!"),window.location.hash="#/login";return}localStorage.setItem("tempLat",l),localStorage.setItem("tempLon",k),window.location.hash="#/tambah"},!e){document.querySelector("#profil-nama").textContent="Pengguna Tamu",document.querySelector("#profil-email").textContent="Silakan login untuk melihat cerita.",document.querySelector("#avatar-huruf").textContent="?",document.querySelector("#avatar-huruf").style.backgroundColor="#ccc",document.querySelector("#btn-notif").style.display="none",document.querySelector("#link-favorit").style.display="none",document.querySelector("#kumpulan-cerita").innerHTML='<p style="text-align: center; width: 100%; grid-column: 1 / -1; color: #ff4d4d; font-weight: bold;">Anda harus masuk untuk melihat cerita warga.</p>';const l=document.querySelector("#btn-logout");l&&(l.textContent="Masuk (Login)",l.addEventListener("click",()=>window.location.hash="#/login")),L.marker([-6.597463,106.79956]).addTo(n).bindPopup('<b>Peta masih kosong! 🗺️</b><br><a href="#/login">Masuk</a> sekarang untuk berbagi cerita.').openPopup();return}const i=localStorage.getItem("userName")||"Pengguna Tanpa Nama",c=localStorage.getItem("userEmail")||"Email tidak diketahui";document.querySelector("#profil-nama").textContent=i,document.querySelector("#profil-email").textContent=c;const s=document.querySelector("#avatar-huruf");s&&(s.textContent=i.charAt(0).toUpperCase());const u=document.querySelector("#btn-logout");u&&u.addEventListener("click",async()=>{if(confirm("Apakah Anda yakin ingin keluar?")){localStorage.removeItem("userToken"),localStorage.removeItem("userName"),localStorage.removeItem("userEmail");try{await C.clearAllStories()}catch(l){console.error("Gagal mengosongkan IndexedDB:",l)}window.location.hash="#/login",window.location.reload()}});const b=new ke;await new ve({view:b,model:oe}).loadStories(e,n),(async()=>{const l=document.querySelector("#btn-notif");if(!l)return;const k=y=>{const f="=".repeat((4-y.length%4)%4),d=(y+f).replace(/-/g,"+").replace(/_/g,"/"),p=window.atob(d),m=new Uint8Array(p.length);for(let g=0;g<p.length;++g)m[g]=p.charCodeAt(g);return m};try{if("serviceWorker"in navigator&&"PushManager"in window){const y=await navigator.serviceWorker.getRegistration();if(!y){l.textContent="SW Belum Terdaftar",l.disabled=!0,console.warn("Service Worker belum terdaftar. Cek file index.js dan Webpack-mu.");return}let f=await y.pushManager.getSubscription();l.textContent=f?"🔕 Matikan Notifikasi":"🔔 Aktifkan Notifikasi",l.addEventListener("click",async()=>{l.disabled=!0;const d=localStorage.getItem("userToken");try{if(f)await fetch("https://story-api.dicoding.dev/v1/notifications/subscribe",{method:"DELETE",headers:{"Content-Type":"application/json",Authorization:`Bearer ${d}`},body:JSON.stringify({endpoint:f.endpoint})}),await f.unsubscribe(),f=null,l.textContent="🔔 Aktifkan Notifikasi",alert("Notifikasi berhasil dimatikan.");else{const m=k("BCCs2eonMI-6H2ctvFaWg-UYdDv387Vno_bzUzALpB442r2lCnsHmtrx8biyPi_E-1fSGABK_Qs_GlvPoJJqxbk");f=await y.pushManager.subscribe({userVisibleOnly:!0,applicationServerKey:m});const g=f.toJSON(),D={endpoint:g.endpoint,keys:{p256dh:g.keys.p256dh,auth:g.keys.auth}},B=await fetch("https://story-api.dicoding.dev/v1/notifications/subscribe",{method:"POST",headers:{"Content-Type":"application/json",Authorization:`Bearer ${d}`},body:JSON.stringify(D)}),T=await B.json();if(!B.ok)throw console.error("Pesan dari server:",T),new Error("Gagal dari server: "+T.message);l.textContent="🔕 Matikan Notifikasi",alert("Notifikasi berhasil. Anda akan menerima notifikasi jika ada cerita baru.")}}catch(p){console.error("Gagal mengatur notifikasi:",p),alert("Akses notifikasi ditolak atau terjadi kesalahan jaringan.")}l.disabled=!1})}else l.textContent="Notifikasi Tidak Didukung",l.disabled=!0}catch(y){console.error("Error mengecek status notifikasi:",y),l.textContent="Gagal Memuat Status",l.disabled=!0}})()}catch(e){console.error("Ada yang salah dengan map/render awal:",e)}}}class xe{async render(){return`
    ...
    `}async afterRender(){const e=document.querySelector("#cerita-favorit");try{const t=await C.getAllStories();if(!t||t.length===0){e.innerHTML=`
        ...
        `;return}let o="";t.forEach(n=>{const r=new Date(n.createdAt).toLocaleDateString("id-ID",{year:"numeric",month:"long",day:"numeric"});let i="";if(n.lat&&n.lon){const c=parseFloat(n.lat).toFixed(3),s=parseFloat(n.lon).toFixed(3);i=`<p class="cerita-date cerita-loc">📍 Lokasi: ${c}, ${s}</p>`}else i='<p class="cerita-date cerita-loc">📍 Lokasi: Tidak disematkan</p>';o+=`
    ...
    `}async afterRender(){const e=document.querySelector("#form-register"),t=document.querySelector("#btn-register");e.addEventListener("submit",async o=>{o.preventDefault();const n=document.querySelector("#name").value,r=document.querySelector("#email").value,i=document.querySelector("#password").value;t.textContent="Mendaftarkan...",t.disabled=!0;try{const s=await(await fetch("https://story-api.dicoding.dev/v1/register",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({name:n,email:r,password:i})})).json();s.error?(alert(`Gagal Mendaftar: ${s.message}`),t.textContent="Daftar Sekarang",t.disabled=!1):(alert("Pendaftaran Berhasil! Silakan Login menggunakan akun yang baru dibuat."),window.location.hash="#/login")}catch(c){console.error("Error saat mendaftar:",c),alert("Terjadi kesalahan jaringan. Pastikan internet Anda stabil."),t.textContent="Daftar Sekarang",t.disabled=!1}})}}const F={"/":new we,"/favorit":new xe,"/tambah":new Se,"/login":new Le,"/daftar":new Te};function Ce(a){const e=a.split("/");return{resource:e[1]||null,id:e[2]||null}}function Ee(a){let e="";return a.resource&&(e=e.concat(`/${a.resource}`)),a.id&&(e=e.concat("/:id")),e||"/"}function Ie(){return location.hash.replace("#","")||"/"}function Pe(){const a=Ie(),e=Ce(a);return Ee(e)}var I,w,x,j,ae;class De{constructor({navigationDrawer:e,drawerButton:t,content:o}){A(this,j);A(this,I,null);A(this,w,null);A(this,x,null);q(this,I,o),q(this,w,t),q(this,x,e),_(this,j,ae).call(this)}async renderPage(){const e=Pe(),t=F[e];if(!t){console.warn(`Halaman untuk rute ${e} tidak ditemukan.`),h(this,I).innerHTML=await F["/"].render(),await F["/"].afterRender();return}h(this,I).innerHTML=await t.render(),await t.afterRender(),h(this,I).focus()}}I=new WeakMap,w=new WeakMap,x=new WeakMap,j=new WeakSet,ae=function(){h(this,w).addEventListener("click",()=>{const e=h(this,x).classList.toggle("open");h(this,w).setAttribute("aria-expanded",e)}),document.body.addEventListener("click",e=>{!h(this,x).contains(e.target)&&!h(this,w).contains(e.target)&&(h(this,x).classList.remove("open"),h(this,w).setAttribute("aria-expanded","false")),h(this,x).querySelectorAll("a").forEach(t=>{t.contains(e.target)&&(h(this,x).classList.remove("open"),h(this,w).setAttribute("aria-expanded","false"))})})};document.addEventListener("DOMContentLoaded",async()=>{const a=new De({content:document.querySelector("#main-content"),drawerButton:document.querySelector("#drawer-button"),navigationDrawer:document.querySelector("#navigation-drawer")}),e=document.querySelector(".skip-link"),t=document.querySelector("#main-content");e&&t&&e.addEventListener("click",i=>{i.preventDefault(),t.scrollIntoView({behavior:"smooth"}),t.focus()});const o=()=>{const i=localStorage.getItem("userToken"),c=document.getElementById("nav-login"),s=document.getElementById("nav-daftar"),u=document.getElementById("nav-logout"),b=document.getElementById("nav-tambah");i?(c&&(c.style.display="none"),s&&(s.style.display="none"),u&&(u.style.display=""),b&&(b.style.display="")):(c&&(c.style.display=""),s&&(s.style.display=""),u&&(u.style.display="none"),b&&(b.style.display="none"))},n=document.getElementById("btn-keluar-global");n&&n.addEventListener("click",async()=>{if(confirm("Apakah Anda yakin ingin keluar dari aplikasi?")){localStorage.removeItem("userToken"),localStorage.removeItem("userName"),localStorage.removeItem("userEmail");try{await C.clearAllStories()}catch(c){console.error("Gagal mengosongkan IndexedDB:",c)}o(),window.location.hash="#/login",window.location.reload()}});const r=async()=>{o(),document.startViewTransition?document.startViewTransition(async()=>{await a.renderPage(),window.scrollTo(0,0)}):(await a.renderPage(),window.scrollTo(0,0))};"serviceWorker"in navigator&&window.addEventListener("load",()=>{navigator.serviceWorker.register("/sw.js").then(i=>{console.log("Service Worker berhasil didaftarkan:",i.scope)}).catch(i=>{console.error("Pendaftaran Service Worker gagal:",i)})}),await r(),window.addEventListener("hashchange",async()=>{await r()})});
